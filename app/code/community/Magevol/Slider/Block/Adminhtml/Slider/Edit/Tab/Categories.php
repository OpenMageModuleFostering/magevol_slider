...
class Magevol_Slider_Block_Adminhtml_Slider_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
	...
	{
		parent::__construct();
		$this->setTemplate('magevol/slider/edit/categories.phtml');
	}
